---
title: "Group Assignment: Problem 11"
date: '2022-06-09'
...
## Q1. Find the cp value that maximize _precision_
...
## Q2. Find the cp value that maximize _accuracy_
```{r, warning = FALSE, echo = TRUE}
cp_precision_df[which.max(cp_precision_df[, 'accuracy']), ]
```

## Q3-1. Prune the tree using the cp value that maximize _precision_
```{r, warning = FALSE, echo = TRUE}
...
## Q3-2. Find the _corresponding precision_ based on the test data
```{r, warning = FALSE, echo = TRUE}
